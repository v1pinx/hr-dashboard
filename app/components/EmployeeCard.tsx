    ...
    <div className="rounded-lg border shadow-sm hover:shadow-lg transition-shadow duration-300 w-full max-w-xs border-neutral-700">
      ...
      <div className="p-4 border-b border-zinc-800 flex justify-between items-center">
        ...
        <button
          ...
          className="h-8 w-8 inline-flex items-center justify-center rounded-full cursor-pointer hover:bg-zinc-800 transition-colors"
        >
          <Bookmark
            className={`h-4 w-4 ${
      ...
      <div className="px-6 py-4 flex flex-col items-center">
        <div className="h-20 w-20 rounded-full overflow-hidden bg-zinc-700 border-2 border-zinc-800 shadow-sm mb-3">
          <img
      ...
      {/* Footer */}
      <div className="flex items-center justify-between p-4 border-t border-zinc-800 light:bg-zinc-50  rounded-b-lg">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="h-9 w-9 inline-flex items-center justify-center rounded-md border border-zinc-800 cursor-pointer hover:bg-zinc-800 transition-colors"
          >
